...
//
            ...
            console.log("4"+context.fillStyle )
            context.fill();
            if (options.strokeStyle && options.lineWidth) {
                context.stroke();
            }
...
//
            context.fillStyle = options.label.fillStyle || 'white';
            console.log("5"+context.fillStyle )
            if (options.label.font) {
                context.font = options.label.font;
            }
    ...
    drawContext(context, dataSet, options, nwPixel) {
        ...
        switch (self.options.draw) {
            ...
            case 'clip':
                ...
                console.log("7"+context.fillStyle )
    ...
    _canvasUpdate(time) {
        ...
        if (self.isEnabledTime()) {
            ...
            if (this.context == '2d') {
                ...
                console.log("颜色8"+context.fillStyle )
                context.fillRect(0, 0, context.canvas.width, context.canvas.height);
                context.restore();
            }
        } else {
...
CanvasLayer$2.prototype.requestAnimFrame_ =
    ...
    global$3.webkitRequestAnimationFrame ||
    global$3.mozRequestAnimationFrame ||
    global$3.oRequestAnimationFrame ||
    global$3.msRequestAnimationFrame ||
    function(callback) {
...
CanvasLayer$2.prototype.cancelAnimFrame_ =
    global$3.cancelAnimationFrame ||
    global$3.webkitCancelAnimationFrame ||
    global$3.mozCancelAnimationFrame ||
    global$3.oCancelAnimationFrame ||
    global$3.msCancelAnimationFrame ||
    function(requestId) {};
...
CanvasLayer$2.prototype.repositionCanvas_ = function() {
  ...
  this.canvas.style[CanvasLayer$2.CSS_TRANSFORM_] = 'translate(' +
...
CanvasLayer$2.prototype.scheduleUpdate = function() {
  if (this.isAdded_ && !this.requestAnimationFrameId_) {
    this.requestAnimationFrameId_ =
        this.requestAnimFrame_.call(global$3, this.requestUpdateFunction_);
  }
};
...
class Layer$2 extends BaseLayer{
    ...
    constructor(map, dataSet, options) {
        ...
        var canvasLayer = this.canvasLayer = new CanvasLayer$2(canvasLayerOptions);
