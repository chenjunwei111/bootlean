(function($, window, document, undefined) {
    var pluginName = "bootstrapDualListbox",
        defaults = {
            ...
            filterTextClear: "清空",
            filterPlaceHolder: "搜索：用户名/电话号码/归属部门",// "Filter",
    ...
    BootstrapDualListbox.prototype = {
        init: function() {
            this.container = $("" + '<div class="bootstrap-duallistbox-container">' + ' <div class="box1">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear1 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" class="select3"></select>' + " </div>" + ' <div class="btn-box">' + '     <button type="button" class="btn db-btn move">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn moveall">' + "       <i></i>" + "       <i></i>" + "     </button>" + '     <p class="clearfix" style="margin-bottom:20px"></p>' + '     <button type="button" class="btn db-btn remove">' + "       <i></i>" + "     </button>" + '     <button type="button" class="btn db-btn removeall">' + "       <i></i>" + "       <i></i>" + "     </button>" + " </div>" + ' <div class="box2">' + "   <label></label>" + '   <span class="info-container">' + '     <span class="info"></span>' + '     <button type="button" class="btn clear2 pull-right"></button>' + "   </span>" + '   <input class="filter form-control ue-form" type="text">' + '   <select multiple="multiple" class="select3"></select>' + " </div>" + ' <div class="settingUp-btns">' + '    <button class="btn db-btn upBtn">' + "      <i></i>" + "    </button>" + '    <button class="btn db-btn downBtn">' + "      <i></i>" + "    </button>" + " </div>" + "</div>").insertBefore(this.element);
            this.elements = {
        ...
        setBootstrap2Compatible: function(value, refresh) {
            ...
            if (value) {
                ...
                this.container.find(".moveall > i, .move > i").removeClass("glyphicon glyphicon-menu-right").addClass("icon-menu-right");
                this.container.find(".removeall > i, .remove > i").removeClass("glyphicon glyphicon-menu-left").addClass("icon-menu-left");
                this.container.find(".upBtn > i").removeClass("glyphicon glyphicon-menu-up").addClass("icon-menu-up");
                this.container.find(".downBtn > i").removeClass("glyphicon glyphicon-menu-down").addClass("icon-menu-down")
            } else {
                ...
                this.container.find(".moveall > i, .move > i").removeClass("icon-menu-right").addClass("glyphicon glyphicon-menu-right");
                this.container.find(".removeall > i, .remove > i").removeClass("icon-menu-left").addClass("glyphicon glyphicon-menu-left");
                this.container.find(".upBtn > i").removeClass("icon-menu-up").addClass("glyphicon glyphicon-menu-up");
                this.container.find(".downBtn > i").removeClass("icon-menu-down").addClass("glyphicon glyphicon-menu-down")
            }
            if (refresh) {
                refreshSelects(this)
            }
