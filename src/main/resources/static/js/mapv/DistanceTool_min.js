...
(function () {
    ...
    d.prototype._processLastOp = function () {
        ...
        ee = {};
        ee.points = i._points.slice(0);
        ee.paths = i._paths.slice(0);
        ee.dots = i._dots.slice(0);
        ee.segDis = i._segDistance.slice(0);
        var j = i._map.pointToPixel(ee.points[ee.points.length - 1]);
        var h = i._map.pointToPixel(ee.points[ee.points.length - 2]);
        var k = [0, 0];
        var f = [0, 0];
        if (j.y - h.y >= 0) {
            f = [-5, 11]
        ...
        var n = ee.points[ee.points.length - 1];
    ...
    var cls = function (r) {
        for (var p = 0, o = ee.points.length; p < o; p++) {
            ee.points[p].disLabel.remove();
            ee.points[p].disLabel = null
        }
        for (var p = 0, o = ee.paths.length; p < o; p++) {
            ee.paths[p].remove();
            ee.paths[p] = null
        }
        for (var p = 0, o = ee.dots.length; p < o; p++) {
            ee.dots[p].remove();
            ee.dots[p] = null
        }
        ee.closeBtn = null;
    ...
    d.prototype.closeMesure = function () {
        cls();
    };
