...
window.BMAP_AUTHENTIC_KEY = ""; (function() {
	...
	//
	z.ma=document.location.origin+'/contra/js/olmap/'
...
return;
    ...
    x.object.extend(I, {
        ...
        Q3: {},
        iG: {
            ZP: z.ma + "getmodules?v=2.0&t=20180901",
            zU: 5E3
        },
        DC: q,
        Pd: {
            ...
            if (d.Bd == this.Fj.dq) c && b();
                ...
                if (d.Bd == this.Fj.pG) {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function() {
                      ...
                      0 == a.length ? e.WK() : oa("../../js/olmap/map-modules.js")
                        },
                        1));
                    d.Bd = this.Fj.IP
                }
    ...
    Ka.prototype.Ob = function(a, b) {
        if (a instanceof sc && b instanceof H) {
            ...
            c.Om ? c.Om.ta(b) : (c.Om = new U(b, {
                icon: new pc(z.ma + "/images/blank.gif", {
                    width: 1,
                    height: 1
                }),
                offset: new L(0, 0),
    ...
    Kc.prototype.bo = function() {
        this.Ib.src = 0 < x.da.la && 6 >= x.da.la && this.rJ ? z.ma + "/images/blank.gif": "" !== this.src && this.Ib.src == this.src ? this.src + "&t = " + Date.now() : this.src
    };
    function Hc(a) {
