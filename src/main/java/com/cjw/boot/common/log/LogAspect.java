package com.cjw.boot.common.log;
...
import com.cjw.boot.shiro.util.ShiroUtils;
import com.cjw.boot.util.ServletUtils;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.cjw.boot.common.log.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            // 获取当前的用户
            UserPojo currentUser = ShiroUtils.getUser();
