...
import com.cjw.boot.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils
{
    ...
    public static final String upload(MultipartFile file,String fileName) throws IOException
    {
        try
        {
            return upload(getDefaultBaseDir(), file, FileUploadUtils.IMAGE_JPG_EXTENSION,fileName);
        }
        catch (Exception e)
        {
    ...
    public static final String upload(String baseDir, MultipartFile file) throws IOException
    {
        try
        {
            return upload(baseDir, file, FileUploadUtils.IMAGE_JPG_EXTENSION,null);
        }
        catch (Exception e)
        {
            throw new IOException(e);
     ...
     */
    public static final String upload(String baseDir, MultipartFile file, String extension,String fileName)
